                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="#" class="btn btn-sm btn-danger"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#eliminarModal{{ $infantil->id }}">
...
<!-- Modal para Editar -->
                    ...
                    <form method="POST" action="{{ route('lsttinfantil.update', $infantil->id) }}">
                        ...
                        @method('PUT')
                            <div class="mb-3">
                                ...
                                <select id="estado" class="form-select" id="estado" name="estado" value="{{ $infantil->estado }}">
    ...
    <!-- MODAL DE ELIMINAR -->
        ...
        <div class="modal fade" id="eliminarModal{{ $infantil->id }}" tabindex="-1" aria-labelledby="eliminarModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('lsttinfantil.destroy', $infantil->id) }}">
                        @csrf
                        @method('DELETE')
