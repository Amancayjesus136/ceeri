                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <p class="text-muted">
                                            según la LOPDDD (Ley Orgánica de Protección de Datos Personales y garantía de los derechos digitales),
                                    ...
                                    <div>
                                        <h5>¿Con qué finalidad trataremos tus datos personales?</h5>
                                        <p class="text-muted"> 
                                        En CEERI, trataremos tus datos personales recabados a través del Sitio Web: Ceeri.com.pe </p>
                                        <p class="text-muted">con las siguientes finalidades:</p>
                                        <ul class="text-muted vstack gap-2">
                                            ...
                                            <li>
                                                3. Remitir boletines (newsletters), así como comunicaciones comerciales de promociones y/o publicidad de CEERI y del sector.
                                            </li>
                                        </ul>
                                        <p class="text-muted">
                                    ...
                                    <div>
                                        ...
                                        <h5>Legitimación:</h5>
                                        <p class="text-muted"> El tratamiento de tus datos se realiza con las siguientes bases jurídicas que legitiman el mismo:</p>
                                        <ul class="text-muted vstack gap-2">
                                            <li>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">
                                             (ENCARGADO) ______________________________________________________, con domicilio en ___________________________________________,
                                            NIF/CIF nº ________________________, presta servicios de ________________________________________ .
                                        </p>
                                        <p class="text-muted">
                                    ...
                                    <div>
                                        <h5>Retención de datos en conformidad a la LSSI</h5>
                                        <p class="text-muted"> 
                                         ...
                                         <p class="text-muted"> 
                                            ...
                                            sólo podrán ser utilizados en el marco de una investigación criminal o para la salvaguardia de la seguridad pública, poniéndose
                                        ...
                                        <h5> Derechos propiedad intelectual: CEERI</h5>
                                        <p class="text-muted">
                                            ...
                                            el mismo, así como de los programas necesarios para su implementación y la información relacionada. No se permite la reproducción,
                                            publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, del sitio web
                                            Ceeri.com.pe sin el consentimiento previo y por escrito.
                                        </p>
                                        <h5>propiedad intelectual de software</h5>
                                        <p class="text-muted">
                                            El usuario debe respetar los programas de terceros puestos a su disposición por CEERI, aun siendo gratuitos
                                            y/o de disposición pública. <br><br>

                                            CEERI dispone de los derechos de explotación y propiedad intelectual necesarios del software. <br><br>
                                            ...
                                            necesarios para el cumplimiento de los servicios contratados y únicamente durante la duración de los mismos. <br><br>
                                    ...
                                    <div>
                                        ...
                                        <ul class="text-muted vstack gap-2">
                                            ...
                                            <li>
                                                • La publicación o la transmisión de cualquier contenido que, a juicio de CEERI, resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.
                                            </li>
                                            <li>
                                    ...
                                    <div>
                                        <h5>Derechos de terceros y protección de menores.</h5>
                                        <p class="text-muted"> 
