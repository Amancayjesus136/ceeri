    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card shadow p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    <h3 class="card-title text-center">Reservar Citas de Terapia Ocupacional</h3><br><br>
                    @if(session('success'))
                    ...
                    <form action="{{ route('lsttocupacional.store') }}" method="POST" id="reservation-form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="genero" name="especialidad" required>
                                        ...
                                        <option value="terapia_fisica">TERAPIA OCUPACIONAL</option>
                                    </select>
                                </div>
                                <div>
                                    <div class="col-lg-6">
